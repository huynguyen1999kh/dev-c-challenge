            ...
            <View style={this.container(this.props.onSetting)}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity style={styles.buttonClose}
                        ...
                        <MaterialCommunityIcons name="window-close" size={32} color="rgb(193,6,51)" />
                    </TouchableOpacity>
                </View>
                <Text style={styles.message}>win: {this.props.win} - draw: {this.props.draw} - lose: {this.props.lose}</Text>
                <Text style={styles.message}>your winrate: {winRate}%</Text>
                <TouchableOpacity style={styles.button}
                    onPress={this.props.reset}>
                    <Text style={{ color: '#fff', fontSize: 18, fontWeight: '400' }}>Reset</Text>
                </TouchableOpacity>
            </View>
        )
    }
